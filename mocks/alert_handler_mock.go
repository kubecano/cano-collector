...
func (m *MockAlertHandlerInterface) HandleAlert(c *gin.Context) {
	m.ctrl.T.Helper()
	m.ctrl.Call(m, "HandleAlert", c)
}

// HandleAlert indicates an expected call of HandleAlert.
func (mr *MockAlertHandlerInterfaceMockRecorder) HandleAlert(c interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "HandleAlert", reflect.TypeOf((*MockAlertHandlerInterface)(nil).HandleAlert), c)
}
