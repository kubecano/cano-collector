...
// Source: github.com/kubecano/cano-collector/config (interfaces: DestinationsLoader)
...
func (m *MockDestinationsLoader) Load() (*config.DestinationsConfig, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "Load")
	ret0, _ := ret[0].(*config.DestinationsConfig)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}
