...
// Source: github.com/kubecano/cano-collector/pkg/interfaces (interfaces: AlertFormatterInterface)
...
func (m *MockAlertFormatterInterface) FormatAlert(arg0 interface{}) string {
	m.ctrl.T.Helper()
