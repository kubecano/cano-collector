...
func (m *MockRouterInterface) StartServer(router *gin.Engine) {
	m.ctrl.T.Helper()
	m.ctrl.Call(m, "StartServer", router)
}

// StartServer indicates an expected call of StartServer.
func (mr *MockRouterInterfaceMockRecorder) StartServer(router interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "StartServer", reflect.TypeOf((*MockRouterInterface)(nil).StartServer), router)
}
