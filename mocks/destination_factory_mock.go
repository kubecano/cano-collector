...
// Source: github.com/kubecano/cano-collector/pkg/destination/interfaces (interfaces: DestinationFactoryInterface)
...
func (m *MockDestinationFactoryInterface) CreateDestination(arg0 interface{}) (interface{}, error) {
	m.ctrl.T.Helper()
...
func (mr *MockDestinationFactoryInterfaceMockRecorder) CreateDestination(arg0 interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "CreateDestination", reflect.TypeOf((*MockDestinationFactoryInterface)(nil).CreateDestination), arg0)
}
