...
func TestEnrichmentType_Constants(t *testing.T) {
	...
	assert.Equal(t, EnrichmentTypeAlertMetadata, EnrichmentType(2))
	assert.Equal(t, EnrichmentTypeGraph, EnrichmentType(3))
	assert.Equal(t, EnrichmentTypeAIAnalysis, EnrichmentType(4))
	assert.Equal(t, EnrichmentTypeNodeInfo, EnrichmentType(5))
	assert.Equal(t, EnrichmentTypeContainerInfo, EnrichmentType(6))
	assert.Equal(t, EnrichmentTypeK8sEvents, EnrichmentType(7))
	assert.Equal(t, EnrichmentTypeDiff, EnrichmentType(8))
	assert.Equal(t, EnrichmentTypeTextFile, EnrichmentType(9))
	assert.Equal(t, EnrichmentTypeCrashInfo, EnrichmentType(10))
	assert.Equal(t, EnrichmentTypeImagePullBackoffInfo, EnrichmentType(11))
	assert.Equal(t, EnrichmentTypePendingPodInfo, EnrichmentType(12))
}
